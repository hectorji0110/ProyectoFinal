    ...
    <section className="py-20 bg-blue-100 dark:bg-gray-800">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="w-16 h-16 flex items-center justify-center rounded-full bg-orange-500 text-white text-3xl">
              <img src="../src/assets/search.svg" alt="Buscar" className="w-12 h-12 object-contain" />
        </div>
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-2">
          ...
          <div className="flex flex-col items-center">
        <div className="w-16 h-16 flex items-center justify-center rounded-full bg-orange-500 text-white text-3xl">
              <img src="../src/assets/material-symbols-light--map-pin-heart-rounded.svg" alt="Buscar" className="w-12 h-12 object-contain" />
        </div>
          ...
          <div className="flex flex-col items-center">
        <div className="w-16 h-16 flex items-center justify-center rounded-full bg-orange-500 text-white text-3xl">
              <img src="../src/assets/material-symbols-light--garage-home-rounded.svg" alt="Buscar" className="w-12 h-12 object-contain" />
        </div>
